...
class Movo_movement(object): 
	...
	def go_home(self):		# Goes to its initial position.
		...
		self.movo_base.motion_stop()
def Left_pos():
	my_robot_left = Movo_movement('left_arm')
	my_robot_left.go_to_joint_state([1.57, 1.4, 2.5, 1.09, 0, 0])
	my_robot_left.go_to_joint_state([1.57,0.9,2.6,-1.1,0,0])
	my_robot_left.go_to_joint_state([1.57,0.9,2.6,-1.1,-1,0])
	my_robot_left.go_to_joint_state([1.57,0.9,2.6,-1.1,1,0])
	my_robot_left.go_to_joint_state([1.57,0.9,2.6,-1.1,-1,0])
	my_robot_left.go_to_joint_state([1.57,0.9,2.6,-1.1,0,0])
	my_robot_left.go_to_joint_state([1.57, 1.4, 2.5, 1.09, 0, 0])
def Right_pos():
	my_robot_right = Movo_movement('right_arm')
	my_robot_right.go_to_joint_state([1.57,0.9,2.6,-1.1,0,0])
	my_robot_right.go_to_joint_state([1.57,0.9,2.6,-1.1,-1,0])
	my_robot_right.go_to_joint_state([1.57,0.9,2.6,-1.1,1,0])
	my_robot_right.go_to_joint_state([1.57,0.9,2.6,-1.1,-1,0])
	my_robot_right.go_to_joint_state([1.57,0.9,2.6,-1.1,0,0])
def main():
	...
	Left_pos()
	#Two arms doesn't work
	# t1=Thread(target=Left_pos)
	# t2=Thread(target=Right_pos)
	# t1.start()
	# t2.start()
